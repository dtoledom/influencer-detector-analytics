...
EMR_SH_FILE="s3://influencer-detector/spark-jobserver/configs/emr.sh"
EMR_CONF_FILE="s3://influencer-detector/spark-jobserver/configs/emr.conf"
S3_BUILD_ARCHIVE_DIR="s3://influencer-detector/spark-jobserver/dist"
#######   EDIT THESE - END  ########
